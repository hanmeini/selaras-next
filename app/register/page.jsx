  ...
  return (
        <div className="w-full h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            >
                ...
                <button onClick={() => router.back(-1)} className="lg:hidden z-10 absolute top-5 left-5 w-12 h-12 flex items-center justify-center text-white text-2xl border border-white rounded-full hover:bg-white hover:text-[#003366] transition">
                    ←
                </button>
