    ...
    return (
        <div className="w-full h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            <div 
                ...
                <button onClick={() => router.push('/')} className="lg:hidden z-10000 absolute top-2 left-2 w-12 h-12 flex items-center justify-center text-white text-2xl border border-white rounded-full hover:bg-white hover:text-[#003366] transition">
                    ←
                </button>
