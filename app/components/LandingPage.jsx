        ...
        <section id='home' style={{ backgroundImage: `url('/images/bg-grid.png')` }} className="flex flex-col pt-20 bg-cover bg-center bg-no-repeat h-full min-w-screen">
          ...
          <div className='flex flex-col justify-center relative'>
            <div className='flex flex-row gap-5 justify-center items-center'>
              <img className='object-contain min-w-30 lg:h-96 lg:w-96 lg:min-w-[200px]' src='/images/home1.png' alt="home1" />
              <img className='object-contain min-w-30 lg:h-[300px] lg:w-[400px] lg:min-w-[200px] mt-[70px] lg:mt-[130px]' src='/images/home2.png' alt="home2" />
              <img className='object-contain min-w-30 lg:h-96 lg:w-96 lg:min-w-[200px]' src='/images/home3.png' alt="home3" />
            </div>
            ...
            <div className='bg-white w-full lg:flex lg:flex-row flex flex-col justify-between items-start z-20 p-6'>
              ...
              <div className='flex flex-row gap-3 mr-3 lg:justify-end'>
                <img className='object-contain max-w-1/6' src='/images/airbnb.png' alt="airbnb" />
                <img className='object-contain max-w-1/6' src='/images/traveloka.png' alt="traveloka" />
                <img className='object-contain max-w-1/6' src='/images/trivago.png' alt="trivago" />
                <img className='object-contain max-w-1/6' src='/images/oyo.png' alt="oyo" />
              </div>
            </div>
          </div>
        </section>
