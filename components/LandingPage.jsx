  ...
  return (
    <section id="landingpage" className="overflow-x-hidden">
        ...
        <div className="flex flex-col p-20 justify-center items-center relative">
          ...
          <div className="flex flex-col gap-10 items-center ">
            <h1 className="font-bold text-[2rem] md:text-5xl text-center">
              Jelajahi  sesuai <span className="font-light text-[2rem] md:text-5xl">MOOD</span>-mu
            </h1>
            <p className="text-[#8A9497] max-w-[80%]">
              Selaras bantu kamu temukan liburan terbaik sesuai mood, dengan rekomendasi dari
              <text className="font-bold text-black"> AI</text> ✨
            </p>
          </div>
          <button
            onClick={() => router.push('/SelarasAI')}
            className="bg-[#003366] text-white px-5 py-3 rounded-full font-semibold mt-10 hover:scale-90 duration-300 cursor-pointer"
          >
            Mulai Sekarang
          </button>
        </div>
      ...
      <section id='about' className='min-h-screen min-w-screen flex items-center justify-center relative overflow-x-hidden md:mb-80 lg:mb-52'>
        <img
          src='/images/btr.png'
          className='absolute lg:top-20 md:top-0 md:left-36 bottom-24 -left-20 sm:-bottom-20 w-56 h-56 md:mt-32 md:w-30 md:h-30 items-start justify-start'
          alt='btr'
        />
        <img
          src='/images/gunung.png'
          className='absolute md:top-0 md:right-28 bottom-28 -right-10 sm:-bottom-24 md:mt-32 mt-40 w-56 h-56 md:w-30 md:h-30 items-start justify-start'
          alt='gunung'
        />
        <div className='max-w-2xl text-center top-0 absolute mt-52'>
          ...
          <p className='md:text-4xl px-5 text-3xl mt-4 text-transparent bg-clip-text bg-gradient-to-r from-[#1E1E1E] to-[#D3CFCF] font-semibold font-manrope'>
            Selaras adalah platform rekomendasi perjalanan berbasis AI yang membantu kamu menemukan destinasi liburan sesuai mood dan preferensimu.
          </p>
        </div>  
        <img
          src='/images/emoji-senyum.png'
          className='absolute lg:top-[525px] lg:left-64 md:top-[480px] md:left-24 sm:top-[380px] sm:left-24 left-5 top-[450px] lg:w-20 lg:h-20 w-14 h-14'
          alt='emoji senyum'
        />
        <img
          src='/images/prambanan.png'
          className='absolute lg:bottom-[40px] lg:left-[550px] md:left-[300px] md:-bottom-3 sm:-bottom-16 bottom-28 w-64 h-48 md:w-36 md:h-26'
          alt='prambanan'
        />
        <img
          src='/images/sparkle.png'
          className='lg:bottom-4 lg:right-64 md:-bottom-[30px] md:right-[70px] sm:bottom-24 absolute lg:w-36 right-7 bottom-[400px] lg:h-26 w-24 h-24'
          alt='sparkle'
        />
      </section>
      ...
      <section id='overview'>
        <div className="min-w-screen h-fit overflow-hidden bg-[#003366] px-8 pt-8 relative lg:-mt-32 md:-mt-60">
          <div className="flex flex-col items-start justify-start">
            ...
            <div className="text-start font-manrope font-semibold lg:text-5xl text-3xl mt-5 relative">
              <h1 className="text-[#FAFAFA] leading-snug">
                ...
                <span className="text-[#FFC300] relative inline-block">
                  Cara Baru
                  <img src="/images/ciprat.png" alt="ciprat" className="absolute lg:-top-5 lg:-right-10 lg:w-16 lg:h-14 w-14 h-14 -top-4 -right-12"/>
                </span>
              </h1>
            </div>
            <p className="text-[#DBDBDB] font-manrope lg:text-xl max-w-md text-start">
              Rasakan pengalaman liburan yang lebih personal, sesuai mood dan gayamu.
            </p>
            <button
            ...
            >
              <img src="/images/emot-coba.png" alt="emot coba" className="lg:w-5 lg:h-5 w-3 h-3 mx-3" />
              Coba Sekarang
            </button>
          </div>
              ...
              <div className='w-[320px] h-[412px] rounded-2xl bg-[#FAFAFA] border-[#D6D6D6] border-2 flex flex-col'>
                <div className='flex items-start justify-start'>
                  <div className='flex flex-col items-start justtify-start'>
                    <img src="/images/pp-byan.png" alt="pp-byan" className='p-2 w-16 h-16' />
                ...
                <p className='font-manrope text-lg mx-4 text-left text-[#939393]'>
                  Baru kali ini cari tempat liburan gampang banget. Tinggal pilih mood, langsung dapat rekomendasi yang pas!
                  Selaras benar-benar ngebantu aku nemuin tempat-tempat yang belum pernah kepikiran sebelumnya.
                </p>
              ...
              <div className='flex flex-col gap-3'>
                <div className='w-[420px] h-[200px] rounded-2xl bg-[#FAFAFA] border-[#D6D6D6] border-2 flex flex-col'>
                  ...
                  <div className='flex items-start'>
                    <img src="/images/pp-erland.png" alt="ppErland" className='p-2 w-16 h-16 flex ml-2' />
                ...
                <div className='w-[420px] h-[200px] rounded-2xl bg-[#FAFAFA] border-[#D6D6D6] border-2 flex flex-col'>
                  ...
                  <div className='flex items-start'>
                    <img src="/images/pp-nobel.png" alt="ppNobel" className='p-2 w-16 h-16 flex ml-2' />
                    <div className='flex flex-col items-start justify-center my-auto'>
                ...
                <SwiperSlide key={i}>
                  <div className="w-full rounded-2xl bg-[#FAFAFA] border-[#D6D6D6] border-2 p-4 h-auto min-h-[300px] flex flex-col">
                    ...
                    <div className="flex items-center mt-4">
                      <img src={`/images/${card.image}`} alt={`pp-${card.name}`} className="w-14 h-14 rounded-full mr-3" />
